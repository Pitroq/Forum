...
<body>
    ...
    <article>
        <div style="font-size: 30px; width:700px; float:left; height:100px"><p>Kategoria: PHP</p></div>
        <div style="font-size: 30px; width:200px; padding: 15px;float:right; height:70px"><img style="float:right;"width="65px" src="../img/php.png"></div>
        <br><br><br><br><br><br><br>
        <?php
            include("../connect.php");
            $query = mysqli_query($connect, "SELECT idPytania, login, tytul, tresc, kategoria, data FROM pytania INNER JOIN uzytkownicy ON pytania.idUzytkownika = uzytkownicy.idUzytkownika WHERE kategoria = 'PHP';");
